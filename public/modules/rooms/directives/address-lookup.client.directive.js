  ...
  function($window, Geocoder) {
    return {
        ...
        link: function (scope, element, attr, form) {
          ...
          var autocomplete = new $window.google.maps.places.Autocomplete(element[0], { types: ['geocode'] });
          ...
          function getAddressDetails(place) {
            ...
            for (var i = 0; i < place.address_components.length; i++) {
              ...
              switch (type) {
                case 'street_number': streetNumber = place.address_components[i].long_name; break;
                case 'route': street = place.address_components[i].long_name; break;
                case 'locality': city = place.address_components[i].long_name; break;
                case 'country': country = place.address_components[i].long_name; break;
              }
            }
