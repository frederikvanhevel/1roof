          ...
          scope.$watch('autoCompleteDetails', function(newDetails, oldDetails) {
              if (newDetails) {
                ...
                for (var i = 0; i < newDetails.address_components.length; i++) {
                  ...
                  switch (type) {
                    case 'street_number': streetNumber = newDetails.address_components[i].long_name; break;
                    case 'route': street = newDetails.address_components[i].long_name; break;
                    case 'locality': city = newDetails.address_components[i].long_name; break;
                    case 'country': country = newDetails.address_components[i].long_name; break;
                  }
                }
